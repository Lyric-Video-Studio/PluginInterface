namespace PluginBase
{
    ...
    /// Bool in Action<bool> (saveAndRefreshCallback.Invoke(true) means does the project save actually need to happen. Set it to false for just refresh
    /// </summary>
    public interface ISaveAndRefresh
    {
        void SetSaveAndRefreshCallback(Action<bool> saveAndRefreshCallback);
    }
